                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="hidden sm:flex items-center space-x-2">
                      ...
                      <span className="text-xs text-slate-500 dark:text-slate-400">{getUsageDisplay()}</span>
                    </div>
                  </TooltipTrigger>
                  <TooltipContent>
                    <p>{getTooltipText()}</p>
              ...
              <div className="chat-bubble flex items-start space-x-3">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl rounded-tl-md p-4 shadow-sm border border-slate-200 dark:border-slate-700 max-w-2xl">
                  <p className="text-slate-900 dark:text-white">
                    👋 Welcome to StartSmart! I'm your AI sidekick, ready to help you navigate every step of starting
                    your business.
                  </p>
                  <p className="text-slate-600 dark:text-slate-300 mt-2">
                    Whether you need help with entity formation, compliance, financial planning, or market research, I'm
                    here to guide you through it all. What would you like to work on today?
                  </p>
                  <div className="mt-4 flex flex-wrap gap-2">
                    ...
                    <Button variant="outline" size="sm" onClick={() => handleSuggestionClick("business-plan")}>
                      📋 Business Plan
                    </Button>
                    <Button variant="outline" size="sm" onClick={() => handleSuggestionClick("tax-setup")}>
                      💰 Tax Setup
                    </Button>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl rounded-tl-md p-4 shadow-sm border border-slate-200 dark:border-slate-700">
                  <div className="flex items-center space-x-2">
                    <div className="flex space-x-1">
                      ...
                      <div
                        className="w-2 h-2 bg-[hsl(174,73%,53%)] rounded-full animate-bounce"
        ...
        <div className="flex items-end space-x-3">
          ...
          <Button
            ...
            className={`text-white hover:shadow-lg h-12 w-12 p-0 ${
              usage && !usage.canSend ? "bg-slate-400 hover:bg-slate-500 cursor-not-allowed" : "nexTax-gradient"
            }`}
