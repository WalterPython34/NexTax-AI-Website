"use client"
// components/pricing/FormationPricing.tsx
//
// Formation pricing view — extracted unchanged from the old /pricing page.
// Rendered by PricingPageClient when ?view=formation.
  ...
  const packages = [
    {
      ...
      notIncluded: ["Priority processing", "Expert consultation"],
      popular: false,
      cta: "Get Started",
      savings: "",
    },
    {
      ...
      features: [
        ...
        "24-Hour LLC formation",
        "Priority Email support",
        "StartSmart AI App (Pro)",
      ],
      optionalAddons: ["Registered Agent (+$149/yr)"],
      notIncluded: ["State fees absorbed"],
      popular: true,
    ...
    },
    {
      ...
      features: [
        ...
        "Idea Validation GPT + report",
        "Business Plan & Market Research Study",
        "StartSmart AI App (Premium)",
      ],
      optionalAddons: [],
      notIncluded: [],
      popular: false,
            ...
            <div className="min-w-[900px]">
              ...
              <div className="grid grid-cols-7 gap-2 mb-4">
                ...
                <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-t-xl p-4 text-center relative">
                   <Badge className="absolute -top-1 left-1/2 -translate-x-1/2 bg-emerald-500 text-white text-xs whitespace-nowrap px-5 py-1">
                    Best Value
                  </Badge>
