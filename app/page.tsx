          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
             {/* NEW: AI-Powered Badge */}
              <Badge className="bg-gradient-to-r from-emerald-500/20 to-blue-500/20 text-cyan-400 border-blue-500/30 text-lg px-4 py-2">
              ...
              <Button
                size="lg"
                  className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white px-8 py-6 text-lg font-semibold w-full sm:w-auto mt-4"
                  >
