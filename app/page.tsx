            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/startsmart-gpt-demo">
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-emerald-500 to-cyan-400 hover:from-emerald-600 hover:to-blue-500 text-white px-8 py-6 text-xl font-semibold w-full sm:w-auto"
                  >
