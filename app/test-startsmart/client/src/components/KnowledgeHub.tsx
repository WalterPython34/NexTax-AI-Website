...
import { Search, Book, BookOpen, Lightbulb, Users, Map, Building, Building2, Globe, FileText, IdCard, Handshake, DollarSign, ChevronRight, Clock, ExternalLink, Bot, Brain, Zap, Crown, Download, Sparkles, Lock, Star, ChevronDown, Eye, AlertTriangle } from "lucide-react";
...
const DISCLAIMERS = {
  "Business Model Canvas": "This content is for educational purposes only and does not constitute business or financial advice.",
  "Market Research Essentials": "Information provided is for general guidance only and may not apply to your specific business situation.",
  "Business Idea Validation": "Information provided is for general guidance only and may not apply to your specific business situation.",
  "Finding Co-founders": "Information provided is for general guidance only and may not apply to your specific business situation.",
  "Entity Formation Guide": "This resource does not constitute legal advice. Please consult an attorney before taking legal action.",
  "Licenses & Permits": "Disclaimer: This guide provides general licensing information and is not a substitute for legal or professional advice.",
  "Contracts & Agreements": "Use of these templates is at your own risk. Always consult a legal professional for binding agreements.",
  "Payroll Basics & Compliance": "Tax-related guidance may vary by state or business structure. Please consult a tax advisor."
};
...
const knowledgeCategories = [
  {
    ...
    items: [
      { 
        ...
        tiers: {
          free: { available: true, title: "Basic Idea Validation", description: "Essential validation steps, MVP basics, customer discovery", format: "In-app reader" },
          pro: { available: true, title: "Advanced Validation Tools", description: "MVP testing, scoring frameworks, segment analysis", format: "In-app reader + templates" },
          premium: { available: true, title: "Investor-Grade Validation", description: "Validation summary, AI SWOT analysis, positioning brief", format: "Interactive tools + automation" }
        }
      },
      { 
        icon: Search, 
        ...
        gatingLabel: "🔓 Free Reading",
        tiers: {
          free: { available: true, title: "Basic Market Research", description: "Essential market validation steps", format: "In-app reader" },
          pro: { available: true, title: "Advanced Market Research", description: "GTM planning, competitive analysis", format: "In-app reader + templates" },
          premium: { available: true, title: "Complete Market Research", description: "Full market mapping, AI intelligence", format: "Interactive tools + automation" }
        }
      },
      { 
        icon: Users, 
        ...
        gatingLabel: "🔓 Free Reading",
        tiers: {
          free: { available: true, title: "Basic Co-founder Guide", description: "Essential steps to find the right co-founder", format: "In-app reader" },
          pro: { available: true, title: "Advanced Co-founder Tools", description: "Pitch templates, roles matrix, decision frameworks", format: "In-app reader + templates" },
          premium: { available: true, title: "Complete Co-founder System", description: "Legal bootcamp, AI risk assessment, automated outreach", format: "Interactive tools + automation" }
        }
      },
      { 
        icon: Map, 
        ...
        gatingLabel: "🔓 Free Reading",
        tiers: {
          free: { available: true, title: "Basic BMC Framework", description: "9 key building blocks for business planning", format: "In-app reader" },
          pro: { available: true, title: "Advanced BMC Tools", description: "Industry examples, pitfalls, AI critique prompts", format: "In-app reader + templates" },
          premium: { available: true, title: "Complete BMC System", description: "Investor integration, Lean Canvas mapping, AI SWOT analysis", format: "Interactive tools + automation" }
        }
      },
    ]
  },
  {
    ...
    items: [
      { 
        ...
        gatingLabel: "🔓 Free Reading",
        tiers: {
          free: { available: true, title: "Basic Entity Formation", description: "LLC vs Corporation basics, registration steps, EIN guide", format: "In-app reader" },
          pro: { available: true, title: "Advanced Entity Structures", description: "Multi-member structures, foreign qualification, bylaws templates", format: "In-app reader + templates" },
          premium: { available: true, title: "Investor-Ready Formation", description: "Delaware C-Corp setup, 83(b) elections, legal stack automation", format: "Interactive tools + automation" }
        }
      },
      { 
        icon: IdCard, 
        ...
        gatingLabel: "🔓 Free Reading",
        tiers: {
          free: { available: true, title: "Basic License Guide", description: "License types, finding requirements, AI prompts", format: "In-app reader" },
          pro: { available: true, title: "Advanced Permit Tools", description: "Sales tax permits, industry tools, renewal planning", format: "In-app reader + templates" },
          premium: { available: true, title: "Complete Permit System", description: "Automation stack, multistate compliance, permit dashboards", format: "Interactive tools + automation" }
        }
      },
      { 
        icon: Handshake, 
        ...
        gatingLabel: "🔓 Free Reading",
        tiers: {
          free: { available: true, title: "Basic Contract Guide", description: "Essential contracts, NDAs, service agreements, AI prompts", format: "In-app reader" },
          pro: { available: true, title: "Advanced Contract Tools", description: "Founder agreements, contractor clauses, MSA templates", format: "In-app reader + templates" },
          premium: { available: true, title: "Complete Contract System", description: "AI-powered legal review, dynamic builders, automation templates", format: "Interactive tools + automation" }
        }
      },
      { 
        icon: DollarSign, 
        ...
        gatingLabel: "🔓 Free Reading",
        tiers: {
          free: { available: true, title: "Basic Payroll Guide", description: "W-2 vs 1099, pay frequency, startup checklist", format: "In-app reader" },
          pro: { available: true, title: "Advanced Payroll Tools", description: "Provider comparison, tax calendars, state registration", format: "In-app reader + templates" },
          premium: { available: true, title: "Complete Payroll System", description: "Multistate compliance, global contractors, HR/payroll stack", format: "Interactive tools + automation" }
        }
      },
    ]
  },
      ...
      { 
        ...
        tiers: {
          free: { 
            ...
            description: "New hire checklist, basic CRM tracker, meeting agendas, simple invoice generator, social media calendar", 
          ...
          pro: { 
            ...
            description: "Chart of accounts generator, expense tracker setup, social media calendar, startup checklist builder, equity calculator, email series, pitch deck writer, policy generator", 
          ...
          premium: { 
            ...
            description: "Investor one-pager generator, grant application writer, due diligence doc pack, KPI dashboard, CRM scripts, AI marketing plan, launch roadmapper", 
...
const quickLinks = [
  { name: "IRS Business Structures", url: "https://www.irs.gov/businesses/small-businesses-self-employed/business-structures", external: true },
...
const stateFilingRequirements = [
  {
    ...
    links: [
      ...
      { name: "Secretary of State – Annual Reports", url: "https://www.sos.alabama.gov/business-services/annual-reports" }
    ]
  },
  {
    state: "Alaska",
    ...
    links: [
      ...
      { name: "Secretary of State – Biennial Reports", url: "https://www.commerce.alaska.gov/web/cbpl/BusinessLicenseSearch.aspx" }
    ]
  },
  {
    state: "Arizona",
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Secretary of State – Business Services", url: "https://www.cyberdriveillinois.com/departments/business_services/" }
    ]
  },
  {
    state: "New York",
...
const businessLicenseLookup = [
  {
    ...
    description: "The Alabama Secretary of State offers a business entity search to verify registered businesses (corporations, LLCs, etc.). For specific licenses, contact local county probate offices, as Alabama's business licenses are often issued at the county level."
  },
  {
    state: "Alaska",
    link: "https://www.commerce.alaska.gov/web/cbpl/BusinessLicenseSearch.aspx",
    description: "The Alaska Department of Commerce, Community, and Economic Development provides a search tool for business licenses and professional licenses. You can search by license number, business name, or owner."
  },
  {
    state: "Arizona",
    link: "https://ecorp.azcc.gov/EntitySearch/Index",
    description: "Use the Arizona Corporation Commission's eCorp system to search for registered businesses. For specific licenses (e.g., contractor, professional), check with the Arizona Registrar of Contractors or relevant licensing boards."
  },
  {
    state: "Arkansas",
    link: "https://www.sos.arkansas.gov/corps/search_all.php",
    description: "The Arkansas Secretary of State provides a business entity search for corporations and LLCs. Business licenses are typically issued by local governments, so contact city or county offices for specific license verification."
  },
  {
    state: "California",
    link: "https://bizfileonline.sos.ca.gov/search/business",
    description: "The California Secretary of State's BizFile Online allows searches for registered businesses. For business licenses, check with local city or county offices, as California does not have a statewide general business license lookup. Professional licenses can be verified via the Department of Consumer Affairs."
  },
  {
    state: "Colorado",
    link: "https://www.sos.state.co.us/biz/BusinessEntityCriteriaExt.do",
    description: "The Colorado Secretary of State offers a business entity search. Business licenses are managed locally, so contact city or county clerks for license verification. Professional licenses can be checked via the Department of Regulatory Agencies."
  },
  {
    state: "Connecticut",
    link: "https://service.ct.gov/business/s/onestop",
    description: "The Connecticut Secretary of State provides a business records search for registered entities. For specific licenses, check with local municipalities or the Department of Consumer Protection for professional licenses."
  },
  {
    state: "Delaware",
    link: "https://icis.corp.delaware.gov/Ecorp/EntitySearch/NameSearch.aspx",
    description: "The Delaware Division of Corporations offers a business entity search. For business licenses, contact the Division of Revenue or local governments, as licenses vary by locality."
  },
  {
    state: "Florida",
    link: "https://search.sunbiz.org/Inquiry/CorporationSearch/ByName",
    description: "The Florida Division of Corporations (Sunbiz) provides a search tool for businesses. Local business tax receipts (licenses) are issued by counties or cities, so contact local tax collectors for verification. Professional licenses can be checked via the Department of Business and Professional Regulation."
  },
  {
    state: "Georgia",
    link: "https://ecorp.sos.ga.gov/BusinessSearch",
    description: "The Georgia Secretary of State offers a business entity search. Business licenses are typically issued by local governments, so check with county or city offices. Professional licenses are managed by the Georgia Professional Licensing Boards."
  },
  {
    state: "Hawaii",
    link: "https://hbe.ehawaii.gov/documents/search.html",
    description: "The Hawaii Department of Commerce and Consumer Affairs provides a business entity search. For general business licenses (GET licenses), use the same portal. Professional licenses can also be verified here."
  },
  {
    state: "Idaho",
    link: "https://sosbiz.idaho.gov/search/business",
    description: "The Idaho Secretary of State offers a business search tool. Business licenses are often issued locally, so contact city or county offices. Professional licenses can be checked via the Division of Occupational and Professional Licenses."
  },
  {
    state: "Illinois",
    link: "https://www.ilsos.gov/corporatellc/",
    description: "The Illinois Secretary of State provides a business entity search. Business licenses are managed by local governments, so contact city or county offices. Professional licenses are verified through the Illinois Department of Financial and Professional Regulation."
  },
  {
    state: "Indiana",
    link: "https://bsd.sos.in.gov/PublicBusinessSearch",
    description: "The Indiana Secretary of State offers a business search tool. Local licenses are required in some counties/cities, so verify with local authorities. Professional licenses can be checked via the Professional Licensing Agency."
  },
  {
    state: "Iowa",
    link: "https://sos.iowa.gov/search/business/search.aspx",
    description: "The Iowa Secretary of State provides a business entity search. Business licenses are often local, so contact city or county offices. Professional licenses are managed by the Iowa Professional Licensing Bureau."
  },
  {
    state: "Kansas",
    link: "https://www.kansas.gov/bess/flow/main?execution=e1s1",
    description: "The Kansas Secretary of State offers a business search tool. Business licenses may be required locally, so check with city or county offices. Professional licenses are verified via the Kansas Board of Healing Arts or other boards."
  },
  {
    state: "Kentucky",
    link: "https://web.sos.ky.gov/bussearchnew/",
    description: "The Kentucky Secretary of State provides a business search tool. Local occupational licenses are required in many counties/cities, so verify locally. Professional licenses are managed by the Kentucky Board of Licensure."
  },
  {
    state: "Louisiana",
    link: "https://coraweb.sos.la.gov/commercialsearch/commercialsearch.aspx",
    description: "The Louisiana Secretary of State offers a business filings search. Local licenses are required, so contact parish or city offices. Professional licenses can be verified via the Louisiana State Board of Contractors."
  },
  {
    state: "Maine",
    link: "https://icrs.informe.org/nei-sos-icrs/ICRS?MainPage=x",
    description: "The Maine Secretary of State provides a business entity search. Local licenses are required in many municipalities, so check with city/town offices. Professional licenses are managed by the Office of Professional and Occupational Regulation."
  },
  {
    state: "Maryland",
    link: "https://egov.maryland.gov/BusinessExpress/EntitySearch",
    description: "The Maryland Department of Assessments and Taxation offers a business entity search. Local licenses are required, so contact county or city offices. Professional licenses are verified via the Maryland Department of Labor."
  },
  {
    state: "Massachusetts",
    link: "https://corp.sec.state.ma.us/CorpWeb/CorpSearch/CorpSearch.aspx",
    description: "The Massachusetts Secretary of the Commonwealth provides a business search tool. Local business licenses are issued by cities/towns, so verify locally. Professional licenses are managed by the Division of Professional Licensure."
  },
  {
    state: "Michigan",
    link: "https://cofs.lara.state.mi.us/SearchApi/Search/Search",
    description: "The Michigan Department of Licensing and Regulatory Affairs (LARA) offers a business entity search. Local licenses may be required, so check with city/county offices. Professional licenses are also verified via LARA."
  },
  {
    state: "Minnesota",
    link: "https://mblsportal.sos.state.mn.us/Business/SearchIndex",
    description: "The Minnesota Secretary of State provides a business search tool. Local licenses are required in some cities, so verify locally. Professional licenses are managed by the Minnesota Department of Commerce."
  },
  {
    state: "Mississippi",
    link: "https://corp.sos.ms.gov/corphome/index.aspx",
    description: "The Mississippi Secretary of State offers a business search tool. Local licenses are required, so contact city/county offices. Professional licenses are verified via the Mississippi State Board of Contractors."
  },
  {
    state: "Missouri",
    link: "https://www.sos.mo.gov/BusinessEntity/soskb/Corp.asp?238",
    description: "The Missouri Secretary of State provides a business entity search. Local licenses are required, so check with city/county offices. Professional licenses are managed by the Missouri Division of Professional Registration."
  },
  {
    state: "Montana",
    link: "https://app.mt.gov/bes/",
    description: "The Montana Secretary of State offers a business search tool. Local licenses may be required, so verify with city/county offices. Professional licenses are managed by the Montana Department of Labor and Industry."
  },
  {
    state: "Nebraska",
    link: "https://www.nebraska.gov/sos/corp/corpsearch.cgi",
    description: "The Nebraska Secretary of State provides a business search tool. Local licenses are required in some cities, so check locally. Professional licenses are verified via the Nebraska Department of Health and Human Services."
  },
  {
    state: "Nevada",
    link: "https://esos.nv.gov/EntitySearch/OnlineEntitySearch",
    description: "The Nevada Secretary of State offers a business entity search. A state business license is required and can be verified via the Nevada Department of Taxation. Professional licenses are managed by relevant boards."
  },
  {
    state: "New Hampshire",
    link: "https://quickstart.sos.nh.gov/online/BusinessInquire",
    description: "The New Hampshire Secretary of State provides a business search tool. Local licenses may be required, so contact city/town offices. Professional licenses are verified via the Office of Professional Licensure and Certification."
  },
  {
    state: "New Jersey",
    link: "https://www.njportal.com/DOR/BusinessNameSearch",
    description: "The New Jersey Division of Revenue and Enterprise Services offers a business name search. Local licenses are required, so check with municipalities. Professional licenses are managed by the Division of Consumer Affairs."
  },
  {
    state: "New Mexico",
    link: "https://portal.sos.state.nm.us/BFS/online/CorporationBusinessSearch",
    description: "The New Mexico Secretary of State provides a business search tool. Local licenses may be required, so verify with city/county offices. Professional licenses are managed by the Regulation and Licensing Department."
  },
  {
    state: "New York",
    link: "https://appext20.dos.ny.gov/corp_public/CORPSEARCH.ENTITY_SEARCH_ENTRY",
    description: "The New York Department of State offers a corporation and business entity search. Local licenses are required (e.g., NYC business licenses), so check with city/county offices. Professional licenses are verified via the Office of the Professions."
  },
  {
    state: "North Carolina",
    link: "https://www.sosnc.gov/online_services/search/by_title/_Business_Registration",
    description: "The North Carolina Secretary of State provides a business search tool. Local licenses may be required, so contact city/county offices. Professional licenses are managed by the North Carolina Licensing Boards."
  },
  {
    state: "North Dakota",
    link: "https://firststop.sos.nd.gov/search/business",
    description: "The North Dakota Secretary of State offers a business search tool. Local licenses may be required, so verify with city/county offices. Professional licenses are managed by the North Dakota Department of Labor."
  },
  {
    state: "Ohio",
    link: "https://www5.sos.state.oh.us/ords/f?p=100:7:0::NO:7::",
    description: "The Ohio Secretary of State provides a business search tool. Local licenses are required in some cities, so check locally. Professional licenses are verified via the Ohio eLicense Center."
  },
  {
    state: "Oklahoma",
    link: "https://www.sos.ok.gov/corp/corpinfoform.aspx",
    description: "The Oklahoma Secretary of State offers a business entity search. Local licenses may be required, so contact city/county offices. Professional licenses are managed by the Oklahoma Department of Commerce."
  },
  {
    state: "Oregon",
    link: "https://sos.oregon.gov/business/Pages/find-business-information.aspx",
    description: "The Oregon Secretary of State provides a business registry search. Local licenses are required in some cities, so verify locally. Professional licenses are managed by the Oregon Business Licensing Boards."
  },
  {
    state: "Pennsylvania",
    link: "https://www.corporations.pa.gov/search/corpsearch",
    description: "The Pennsylvania Department of State offers a business entity search. Local licenses are required, so check with city/county offices. Professional licenses are verified via the Bureau of Professional and Occupational Affairs."
  },
  {
    state: "Rhode Island",
    link: "https://business.sos.ri.gov/CorpWeb/CorpSearch/CorpSearch.aspx",
    description: "The Rhode Island Secretary of State provides a business search tool. Local licenses may be required, so contact city/town offices. Professional licenses are managed by the Department of Business Regulation."
  },
  {
    state: "South Carolina",
    link: "https://businessfilings.sc.gov/BusinessFiling/EntitySearch",
    description: "The South Carolina Secretary of State offers a business search tool. Local licenses are required, so verify with city/county offices. Professional licenses are managed by the Department of Labor, Licensing and Regulation."
  },
  {
    state: "South Dakota",
    link: "https://sosenterprise.sd.gov/BusinessServices/Business/FilingSearch.aspx",
    description: "The South Dakota Secretary of State provides a business search tool. Local licenses may be required, so check with city/county offices. Professional licenses are managed by the Department of Labor and Regulation."
  },
  {
    state: "Tennessee",
    link: "https://tnbear.tn.gov/Ecommerce/FilingSearch.aspx",
    description: "The Tennessee Secretary of State offers a business entity search. Local licenses are required in many counties/cities, so verify locally. Professional licenses are managed by the Department of Commerce and Insurance."
  },
  {
    state: "Texas",
    link: "https://mycpa.cpa.state.tx.us/coa/",
    description: "The Texas Secretary of State provides a business entity search. Local licenses are required in some cities, so check with city/county offices. Professional licenses are verified via the Texas Department of Licensing and Regulation."
  },
  {
    state: "Utah",
    link: "https://secure.utah.gov/bes/index.html",
    description: "The Utah Division of Corporations and Commercial Code offers a business search tool. Local licenses may be required, so contact city/county offices. Professional licenses are managed by the Division of Occupational and Professional Licensing."
  },
  {
    state: "Vermont",
    link: "https://bizfilings.vermont.gov/online/BusinessInquire",
    description: "The Vermont Secretary of State provides a business search tool. Local licenses may be required, so verify with city/town offices. Professional licenses are managed by the Office of Professional Regulation."
  },
  {
    state: "Virginia",
    link: "https://sccefile.scc.virginia.gov/Find/Entity",
    description: "The Virginia State Corporation Commission offers a business entity search. Local licenses are required, so check with city/county offices. Professional licenses are verified via the Department of Professional and Occupational Regulation."
  },
  {
    state: "Washington",
    link: "https://secure.dol.wa.gov/dolverification/",
    description: "The Washington State Department of Licensing provides a license lookup tool for professional and business licenses. You can also search business licenses issued through the Department of Revenue's Business Licensing Service or use the Secretary of State's Advanced Business Search for corporations and LLCs."
  },
  {
    state: "West Virginia",
    link: "https://apps.sos.wv.gov/business/corporations/",
    description: "The West Virginia Secretary of State offers a business search tool. Local licenses may be required, so contact city/county offices. Professional licenses are managed by the West Virginia Division of Labor."
  },
  {
    state: "Wisconsin",
    link: "https://www.wdfi.org/apps/CorpSearch/Search.aspx",
    description: "The Wisconsin Department of Financial Institutions provides a business search tool. Local licenses are required in some cities, so verify locally. Professional licenses are managed by the Department of Safety and Professional Services."
  },
  {
    state: "Wyoming",
    link: "https://wyobiz.wy.gov/Business/FilingSearch.aspx",
    description: "The Wyoming Secretary of State offers a business search tool. Local licenses may be required, so check with city/county offices. Professional licenses are managed by the Wyoming Professional Licensing Boards."
  },
  {
    state: "Washington, D.C.",
    link: "https://corponline.dcra.dc.gov/Account/Login",
    description: "The Department of Licensing and Consumer Protection (DLCP) offers the Scout platform to verify Basic Business Licenses (BBL) by license number, address, name, or category. You can also check landlord licenses or contractor ratings. For corporate registrations, use the CorpOnline tool with a free Access DC account."
  }
];

// AI Resource Modal Component  
function AIResourceModal({ resource, isOpen, onClose, onOpenPromptPlayground }: { resource: any; isOpen: boolean; onClose: () => void; onOpenPromptPlayground?: () => void }) {
  ...
  const getTierIcon = (tier: string) => {
    switch (tier) {
      case "free": return <Download className="h-4 w-4" />;
  ...
  const getTierPrice = (tier: string) => {
    switch (tier) {
      ...
      case "pro": return "$29/mo";
      case "premium": return "$79/mo";
      default: return "";
    }
  };
  ...
  const handleReadContent = async (tier: string) => {
    try {
      ...
      if (resource.name === "Market Research Essentials") {
        ...
        const downloadEndpoint = tier === "free" 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                        ...
                        <div>
                          ...
                          {(resource.name === "Market Research Essentials" || resource.name === "Finding Co-founders" || resource.name === "Business Model Canvas" || resource.name === "Business Idea Validation" || resource.name === "Entity Formation Guide" || resource.name === "Licenses & Permits" || resource.name === "Contracts & Agreements" || resource.name === "Payroll Basics & Compliance" || resource.name === "Prompt Playground" || resource.name === "Prompt Engineering Library" || resource.name === "Automation Templates") ? (
                            ...
                            <div className="space-y-2">
                              ...
                              >
                                <Download className="h-4 w-4 mr-2" />
                                {isReading ? "Downloading..." : "Download Excel"}
                              </Button>
                            </div>
                          ) : (
                            <div className="space-y-2">
                      ...
                      <div className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-4 mb-4">
                        ...
                        {resource.name === "Prompt Playground" && (
                          ...
                          >
                            ...
                            {isReading ? "Loading..." : `Preview ${tier.charAt(0).toUpperCase() + tier.slice(1)} Content`}
                          </Button>
                        )}
                      </div>
        ...
        {/* Content Reader View */}
        {content && (resource.name === "Market Research Essentials" || resource.name === "Finding Co-founders" || resource.name === "Business Model Canvas" || resource.name === "Business Idea Validation" || resource.name === "Entity Formation Guide" || resource.name === "Licenses & Permits" || resource.name === "Contracts & Agreements" || resource.name === "Payroll Basics & Compliance" || resource.name === "Prompt Playground" || resource.name === "Prompt Engineering Library" || resource.name === "Automation Templates") && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredResources.map((resource, index) => {
              const getResourceIcon = () => {
                switch (index) {
                  case 0: return Building; // LLC vs S-Corp
                  case 1: return DollarSign; // Tax Setup
                  case 2: return Lightbulb; // Market Research
                  default: return Book;
                }
              };
              ...
              return (
                <Card key={resource.id} className="overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer group hover:scale-[1.02] bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm" onClick={() => handleResourceClick(resource)}>
                ...
                <div className="mb-6">
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-slate-900 dark:text-white">State Filing Requirements</h4>
                        <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">
              ...
              <div className="mt-6 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg border">
                ...
                <div className="mt-4 pt-3 border-t border-slate-200 dark:border-slate-600">
                  <p className="text-xs text-slate-500 dark:text-slate-400">
                    💡 <strong>Tip:</strong> For personalized guidance and detailed planning, consider scheduling a consultation with our experts.
                  </p>
                </div>
              </div>
            )}
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-3">
              <Button 
                onClick={downloadMarketResearchPDF}
      ...
      <Dialog open={showMarketResearchReader} onOpenChange={setShowMarketResearchReader}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
          <DialogHeader className="flex-shrink-0">
            ...
            <DialogDescription>
              Complete guide to AI-powered market validation (12 pages)
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex-shrink-0 border-t pt-4 pb-2">
            <div className="flex justify-between items-center">
              ...
              <div className="flex space-x-2">
                ...
                <Button 
                  variant="default"
                  onClick={() => setShowMarketResearchReader(false)}
                  size="sm"
                >
                  Close
                </Button>
          ...
          <div className="flex-shrink-0 border-t pt-4 pb-2">
            <div className="flex justify-between items-center">
              ...
              <div className="flex space-x-2">
                ...
                <Button 
                  variant="default"
                  onClick={() => setShowTaxSetupReader(false)}
                  size="sm"
                >
                  Close
                </Button>
