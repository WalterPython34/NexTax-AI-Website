...
export function DocumentCenter() {
  ...
  const handleTemplateAction = async (template: any, action: string) => {
    ...
    if (action === "ai_custom") {
      ...
      const proTierTools = ["operating_agreement", "articles_incorporation", "corporate_bylaws", "chart_accounts", "budget_template"];
      ...
      if (template.key === "operating_agreement") {
        ...
        toast({
          ...
          description: "By filling out the below questionnaire, your form will be auto generated, sent to you via email with instructions for you to review and sign, and a copy will then be provided to NexTax.AI where we will proceed to get your EIN for you from the IRS and provide you with a final copy of your SS-4 form complete with your new EIN number at the top of the form.",
          duration: 8000,
        });
  ...
  const getTemplateActions = (template: any) => {
    ...
    if (template.freeAccess === "template") {
      actions.push({
        label: (template.key === "operating_agreement" || template.key === "articles_incorporation" || template.key === "corporate_bylaws" || template.key === "lean_canvas" || template.key === "executive_summary" || template.key === "business_plan_startups") ? "View Template" : "Download Template",
        icon: (template.key === "operating_agreement" || template.key === "articles_incorporation" || template.key === "corporate_bylaws" || template.key === "lean_canvas" || template.key === "executive_summary" || template.key === "business_plan_startups") ? Eye : Download,
        variant: "outline",
        action: "download",
        available: true
      });
    ...
    if (proTierTools.includes(template.key)) {
      ...
      actions.push({
        ...
        tier: "premium",
        tooltip: currentPlan === "premium" ? "Included with $79/mo Plan – Advanced investor tools" : "Unlock with $79/mo Plan – Includes advanced investor tools"
      });
    } else {
    ...
    <section className="flex-1 p-4 lg:p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-slate-600 dark:text-slate-300">AI-powered templates and legal documents for your startup</p>
        </div>
            ...
            <div key={category.category}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {category.templates.map((template) => (
                  <Card key={template.key} className="border-slate-200 dark:border-slate-700 hover:shadow-lg transition-shadow">
                    <CardHeader>
            ...
            <div className="flex-shrink-0 border-t pt-4 pb-2">
              <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button 
                    variant="default"
                    onClick={() => setShowOperatingAgreementReader(false)}
                    size="sm"
                  >
                    Close
                  </Button>
            ...
            <div className="flex-shrink-0 border-t pt-4 pb-2">
              <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button 
                    variant="default"
                    onClick={() => setShowArticlesIncorpReader(false)}
                    size="sm"
                  >
                    Close
                  </Button>
            ...
            <DialogHeader className="flex-shrink-0">
              <DialogTitle className="flex items-center justify-between">
                ...
                <Button 
                  variant="outline" 
                  size="sm" 
                  onClick={downloadCorporateBylaws}
                  className="ml-4"
                >
                  <Download className="h-4 w-4 mr-2" />
                  Download
            ...
            <div className="flex-shrink-0 border-t pt-4 pb-2">
              <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button 
                    variant="default"
                    onClick={() => setShowCorporateBylawsReader(false)}
                    size="sm"
                  >
                    Close
                  </Button>
            ...
            <div className="flex-shrink-0 border-t pt-4 pb-2">
              <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button 
                    variant="default"
                    onClick={() => setShowLeanCanvasViewer(false)}
                    size="sm"
                  >
                    Close
                  </Button>
            ...
            <div className="flex-shrink-0 border-t pt-4 pb-2">
              <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button 
                    variant="default"
                    onClick={() => setShowExecutiveSummaryReader(false)}
                    size="sm"
                  >
                    Close
                  </Button>
            ...
            <div className="flex-shrink-0 border-t pt-4 pb-2">
              <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button 
                    variant="default"
                    onClick={() => setShowBusinessPlanStartupsReader(false)}
                    size="sm"
                  >
                    Close
                  </Button>
        ...
        <Dialog open={showOperatingAgreementGenerator} onOpenChange={setShowOperatingAgreementGenerator}>
          <DialogContent className="max-w-5xl max-h-[95vh] overflow-y-auto p-0">
            <OperatingAgreementGenerator 
              onClose={() => setShowOperatingAgreementGenerator(false)} 
            />
          </DialogContent>
        </Dialog>
        ...
        <Dialog open={showArticlesIncorporationGenerator} onOpenChange={setShowArticlesIncorporationGenerator}>
          <DialogContent className="max-w-5xl max-h-[95vh] overflow-y-auto p-0">
            <ArticlesOfIncorporationGenerator 
              onClose={() => setShowArticlesIncorporationGenerator(false)} 
            />
          </DialogContent>
        </Dialog>
        ...
        <Dialog open={showCorporateBylawsGenerator} onOpenChange={setShowCorporateBylawsGenerator}>
          <DialogContent className="max-w-5xl max-h-[95vh] overflow-y-auto p-0">
            <CorporateBylawsGenerator 
              onClose={() => setShowCorporateBylawsGenerator(false)} 
            />
          </DialogContent>
        </Dialog>
        ...
        <Dialog open={showExecutiveSummaryGenerator} onOpenChange={setShowExecutiveSummaryGenerator}>
          <DialogContent className="max-w-5xl max-h-[95vh] overflow-y-auto p-0">
            <ExecutiveSummaryGenerator 
              onClose={() => setShowExecutiveSummaryGenerator(false)} 
            />
          </DialogContent>
        </Dialog>
        ...
        <Dialog open={showBusinessPlanGenerator} onOpenChange={setShowBusinessPlanGenerator}>
          <DialogContent className="max-w-5xl max-h-[95vh] overflow-y-auto p-0">
            <BusinessPlanGenerator 
              onClose={() => setShowBusinessPlanGenerator(false)} 
            />
          </DialogContent>
        </Dialog>
        ...
        {showChartOfAccountsGenerator && (
          <ChartOfAccountsGenerator 
            onClose={() => setShowChartOfAccountsGenerator(false)} 
          />
        )}

        {/* Expense Tracker Generator */}
        {showExpenseTrackerGenerator && (
          <ExpenseTrackerGenerator 
            onClose={() => setShowExpenseTrackerGenerator(false)} 
          />
        )}

        {/* Lean Canvas Generator */}
        {showLeanCanvasGenerator && (
          <LeanCanvasGenerator 
            onClose={() => setShowLeanCanvasGenerator(false)} 
          />
        )}
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle className="text-xl font-semibold">
                {documentViewerData?.title}
              </DialogTitle>
              <DialogDescription>
                View your generated document content
              </DialogDescription>
            </DialogHeader>
            <div className="mt-4">
