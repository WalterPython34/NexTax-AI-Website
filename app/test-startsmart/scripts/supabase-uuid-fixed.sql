-- StartSmart UUID-Compatible Schema
-- Fixes the UUID type mismatch issue
...
-- Skip user_subscriptions insert since existing table has different UUID structure
-- The existing table will work for subscription checking